...
Please see the [AI Usage Policy](https://gitlab.com/GROUP/gl-dash/-/blob/main/AI_POLICY.md). This is very important.

## Quick Guide

### I Have an Idea for a Feature

Like bug reports, first search through existing issues and try to find if your feature has already been requested. Otherwise, [open an issue](https://gitlab.com/GROUP/gl-dash/-/issues/new) describing it.
...
Open an [issue](https://gitlab.com/GROUP/gl-dash/-/issues/new), or join our [Discord Server](https://discord.gg/SXNXp9NctV) and ask away in the #help forum channel.
...
```sh
git clone git@gitlab.com:GROUP/gl-dash.git && cd gl-dash
```
...
- `data/` - the code that fetches data from GitLab's GraphQL/REST APIs
